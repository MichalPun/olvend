if ('serviceWorker' in navigator) {
  window.addEventListener('load', () => {
    (async () => {
      try {
        const PWA_BOOTSTRAP_VERSION = '20260815-mobile-home-inventory-guard-v1';
        ...
        await navigator.serviceWorker.register('./sw.js?v=20260815-mobile-home-inventory-guard-v1');
      } catch (error) {
