-- Aktuální planogram EV 7 / Europa Snack / Pohořelice - Apex.
-- Zdroj: Planogram [7] Europa Snack-2026-07-30.xlsx.
-- TID 582173; expirace se přebírají přesně ze zdrojového souboru.
-- Obecné varianty:
...
begin
  if not exists (
    ...
    where id = 5
      and qr_token = 'vendsoft-7'
      and location_id = 56
  ) then
    raise exception 'EV 7 / Pohořelice - Apex nebyl nalezen na očekávaném DB záznamu.';
  end if;
end
$$;
...
values
  (5, 'IMA', '582173', true, 'TID 582173 pro EV 7 / Europa Snack / Pohořelice - Apex.'),
  (5, 'GP',  '582173', true, 'TID 582173 pro EV 7 / Europa Snack / Pohořelice - Apex.')
...
select
  ...
  'Planogram EV 7 / Pohořelice - Apex / TID 582173 aktualizován ze souboru 2026-07-30.'
from (values
  ...
  ('17', 39::numeric,  5,  6,  6, 39::numeric, 1, '2',   12, 'Big Shock!', 'Exotic', 'Big Shock! Energetický nápoj Exotic 500ml plech', 'exact', null, null, null::date),
  ('18', 28::numeric,  6,  6,  6, 28::numeric, 0, '187', 13, 'Staropramen Cool', 'Citron', 'Staropramen Cool citron nealkoholický nápoj z piva 500ml plech', 'exact', null, null, null::date),
  ('23', 39::numeric,  0,  1,  2, 55::numeric, 2, '79',  14, 'ATM', 'Belgická', 'ATM - Belgická bageta', 'exact', null, null, '2026-08-04'::date),
  ('24', 55::numeric,  1,  1,  1, 55::numeric, 0, '17',  15, 'ATM', 'Kuřecí stripsy', 'ATM - Kuřecí stripsy', 'exact', null, null, '2026-08-04'::date),
  ('25', 55::numeric,  1,  1,  1, 55::numeric, 0, '155', 16, 'ATM', 'Debrecínská', 'ATM Debrecínská bageta', 'exact', null, null, '2026-08-04'::date),
  ('26', 19::numeric,  5,  5,  5, 19::numeric, 0, '38',  17, 'Havlík', 'Originál', 'Havlík Tyčinky originál 90g', 'exact', null, null, '2025-12-23'::date),
  ('27', 25::numeric,  6,  6,  6, 25::numeric, 0, '210', 18, 'Doritos', 'Nachos cheese', 'Doritos Tortillas Chipsy nachos cheese 44g', 'exact', null, null, '2025-12-23'::date),
  ...
  ('34', 26::numeric, 15, 15, 15, 26::numeric, 0, '36',  21, 'Mila', null, 'Mila Oplatky 50g', 'exact', null, null, null::date),
  ('35', 20::numeric,  6,  6,  6, 20::numeric, 0, '35',  22, 'Sedita Horalky', 'Arašídové', 'Sedita Horalky Oplatky arašídové 50g', 'exact', null, null, null::date),
  ('36', 11::numeric,  9, 10, 10, 11::numeric, 1, '33',  23, 'Attack', 'Lískooříšková', 'Attack Oplatka lískooříšková 30g', 'exact', null, null, null::date),
  ('37', 26::numeric, 12, 12, 12, 26::numeric, 0, '24',  24, 'Snickers', null, 'Snickers Tyčinka čokoládová 50g', 'exact', null, null, null::date),
  ('38', 30::numeric, 13, 15, 15, 30::numeric, 2, '28',  25, 'Kinder Bueno', null, 'Kinder Bueno Oplatky 43g', 'exact', null, null, null::date),
  ('39', 25::numeric, 20, 20, 20, 25::numeric, 0, '40',  26, 'Margot', null, 'Margot Tyčinka 80g', 'exact', null, null, null::date),
  ('40',  8::numeric, 15, 15, 15,  8::numeric, 0, '208', 27, 'Alaska', 'Různé druhy', 'Alaska kukuřičné trubičky plněné krémem 18g různé druhy', 'exact', null, null, null::date),
  ('45', 26::numeric, 15, 15, 15, 26::numeric, 0, '25',  28, 'Twix', null, 'Twix Tyčinka 50g', 'exact', null, null, null::date),
  ('46', 24::numeric, 10, 10, 10, 24::numeric, 0, '27',  29, 'Kit Kat', '4 Fingers', 'Kit Kat 4 Fingers Tyčinka 41,5g', 'exact', null, null, null::date),
  ('47', 11::numeric, 10, 10, 10, 11::numeric, 0, '165', 30, 'Knoppers', null, 'Knoppers Oplatka 25g', 'exact', null, null, null::date),
  ('48', 14::numeric,  5,  6,  6, 14::numeric, 1, '254', 31, 'Dr.Ensa', 'Barbecue', 'Dr.Ensa Kukuřice pražená solená s příchutí barbecue 60g', 'exact', null, null, null::date),
  ('49', 24::numeric, 15, 15, 15, 24::numeric, 0, '31',  32, 'Miňonky', 'Oříškové', 'Miňonky Oplatky oříškové 50g', 'exact', null, null, null::date),
  ('50', 30::numeric, 12, 15, 15, 30::numeric, 3, '26',  33, '3Bit', 'Různé druhy', '3Bit tyčinka různé druhy', 'exact', null, null, null::date),
  ('51', 21::numeric, 15, 15, 15, 21::numeric, 0, '213', 34, 'Skittles', 'Ovocné', 'Skittles Bonbóny ovocné žvýkací 38g', 'exact', null, null, null::date),
  ('57', 27::numeric, 10, 10, 10, 27::numeric, 0, '39',  35, 'Haribo', 'Goldbären', 'Haribo Bonbóny goldbären želé medvídci 100g', 'exact', null, null, null::date),
  ('59', 20::numeric,  6,  6,  6, 20::numeric, 0, '42',  36, '7days', 'Lískový oříšek', '7days Croissant lískový oříšek 60g', 'exact', null, null, null::date),
  ('61', 19::numeric,  1,  2,  6, 19::numeric, 5, '139', 37, 'Strážnické brambůrky', 'Česnekové', 'Strážnické brambůrky Chipsy česnekové 60g', 'exact', null, null, null::date),
  ('62', 21::numeric, 13, 13, 13, 21::numeric, 0, '144', 38, 'Yoohoo!', 'Kakao+lískový oříšek', 'Yoohoo! Vafle kakao+lískový oříšek 50', 'exact', null, null, null::date)
) as d(
...
begin
  ...
  where machine_id = 5 and active = true;

  if v_count <> 39 then
    raise exception 'EV 7: očekáváno 39 aktivních pozic, nalezeno %.', v_count;
  end if;
end
$$;
