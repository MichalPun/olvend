-- Import real planogram from: Planogram [58] Luce X2 I_E-2026-07-27.xlsx
-- Machine: DB id 48, VendSoft evidence 58, TID/DeviceID 596505.
-- Location: Jihlava - Sonepar (location_id 32).
-- Z1 is intentionally mapped to Barbera Tris SKU 201; the Excel still carries legacy Elite code 5.

do $$
declare
  v_machine_id bigint := 48;
begin
  ...
  set
    ...
    machine_type = 'Coffee',
    brand = 'Rheavendors',
    note = 'Import z VendSoft exportu; puvodni kod 58; lokalita Jihlava - Sonepar. Telemetry ID: 596505. Zdroj planogramu 2026-07-27.'
  where id = v_machine_id;

  insert into public.machine_external_links (machine_id, provider, external_machine_id, telemetry_enabled, note)
  values
    (v_machine_id, 'IMA', '596505', true, 'TID 596505 pro Luce X2 I/E / automat 58 / Jihlava - Sonepar.'),
    (v_machine_id, 'GP', '596505', true, 'TID 596505 pro Luce X2 I/E / automat 58 / Jihlava - Sonepar.')
  ...
  insert into public.machine_coffee_containers (machine_id, container_code, product_id, product_sku, product_name, capacity_quantity, current_quantity, unit, refill_package_quantity, refill_package_unit, min_refill_quantity, sort_order, active, note) values
    (v_machine_id, 'Z1', 26, '201', 'Barbera Tris 1 kg', 3000, 2890, 'g', 1000, 'g', 1000, 1, true, 'Kod ve VendSoft exportu: 5 / Elite; skladove pouzivame Barbera Tris 1 kg / SKU 201. Import z realneho planogramu 58 / 2026-07-27.'),
    (v_machine_id, 'Z2', 42, '43', 'Cukr Vending 1,5 kg', 3000, 2736, 'g', 1500, 'g', 1500, 2, true, 'Import z realneho planogramu 58 / 2026-07-27.'),
    (v_machine_id, 'Z3', 104, '48', 'oVe COFFEE CREAMER WHITE 1 kg', 2000, 1486, 'g', 1000, 'g', 1000, 3, true, 'Import z realneho planogramu 58 / 2026-07-27.'),
    (v_machine_id, 'Z4', 106, '47', 'oVe DRINK WITH COCOA ZETA 1 kg', 2000, 1690, 'g', 1000, 'g', 1000, 4, true, 'Import z realneho planogramu 58 / 2026-07-27.'),
    (v_machine_id, 'Z5', 108, '44', 'oVe FD COFFEE SOPHIA 500g', 1000, 863, 'g', 500, 'g', 500, 5, true, 'Import z realneho planogramu 58 / 2026-07-27.'),
    (v_machine_id, 'Z6', 110, '46', 'oVe SMART CAPPUCCINO IRISH CREAM FLAVOUR 1000g', 2000, 1842, 'g', 1000, 'g', 1000, 6, true, 'Import z realneho planogramu 58 / 2026-07-27.'),
    (v_machine_id, 'Z7', 105, '51', 'oVe DRINK WITH CHOC WHITE FLAVOUR 1000g', 3000, 2922, 'g', 1000, 'g', 1000, 7, true, 'Import z realneho planogramu 58 / 2026-07-27.'),
    (v_machine_id, 'Z8', 78, '45', 'Kelimek 180 ml (50 ks)', 400, 386, 'ks', 50, 'ks', 50, 8, true, 'Import z realneho planogramu 58 / 2026-07-27. V exportu nazev obsahuje 100 ks, skladove doplnujeme po 50 ks.'),
    (v_machine_id, 'Z9', 80, '53', 'Kelimek 300 ml (50 ks)', 350, 308, 'ks', 50, 'ks', 50, 9, true, 'Import z realneho planogramu 58 / 2026-07-27.'),
    (v_machine_id, 'Z10', 136, '88', 'VICKO HUHTAMAKI PLAST CERNE 300ml', 100, 99, 'ks', 100, 'ks', 100, 10, true, 'Import z realneho planogramu 58 / 2026-07-27.')
  ...
  insert into public.machine_coffee_buttons (machine_id, selection_code, product_id, product_sku, product_name, sale_price_czk, customer_price_czk, settlement_type, settlement_amount_czk, settlement_partner, settlement_billing_enabled, settlement_note, planned_product_name, planned_product_sku, planned_price_czk, substitution_policy, allowed_substitutes, operator_instruction, last_counter, grid_column, grid_row_from_bottom, sort_order, active, note) values
    (v_machine_id, '1', 140, '239', 'Cerna kava 180 ml NEW', 7, 7, 'none', 0, null, false, null, null, null, null, 'exact', null, null, 486, 1, 4, 1, true, 'Import z realneho planogramu 58 / 2026-07-27.'),
    (v_machine_id, '2', 31, '215', 'Bila kava 180 ml NEW', 7, 7, 'none', 0, null, false, null, null, null, null, 'exact', null, null, 610, 1, 3, 2, true, 'Import z realneho planogramu 58 / 2026-07-27.'),
    (v_machine_id, '3', 36, '222', 'Cappuccino 180 ml I NEW', 7, 7, 'none', 0, null, false, null, null, null, null, 'exact', null, null, 667, 1, 2, 3, true, 'Import z realneho planogramu 58 / 2026-07-27.'),
    (v_machine_id, '4', 68, '230', 'Irish Cream 180 ml NEW', 7, 7, 'none', 0, null, false, null, null, null, null, 'exact', null, null, 743, 1, 1, 4, true, 'Import z realneho planogramu 58 / 2026-07-27.'),
    (v_machine_id, '5', 71, '233', 'Kakaovy napoj 180 ml NEW', 7, 7, 'none', 0, null, false, null, null, null, null, 'exact', null, null, 93, 2, 4, 5, true, 'Import z realneho planogramu 58 / 2026-07-27.'),
    (v_machine_id, '6', 73, '234', 'Kakaovy napoj Cream 180 ml NEW', 7, 7, 'none', 0, null, false, null, null, null, null, 'exact', null, null, 246, 2, 3, 6, true, 'Import z realneho planogramu 58 / 2026-07-27.'),
    (v_machine_id, '7', 75, '236', 'KAKAOVY NAPOJ DE LUXE 180 ml NEW', 7, 7, 'none', 0, null, false, null, null, null, null, 'exact', null, null, 202, 2, 2, 7, true, 'Import z realneho planogramu 58 / 2026-07-27.'),
    (v_machine_id, '8', 29, '217', 'Bila kremova 180 ml NEW', 7, 7, 'none', 0, null, false, null, null, null, null, 'exact', null, null, 489, 2, 1, 8, true, 'Import z realneho planogramu 58 / 2026-07-27.'),
    (v_machine_id, '9', 58, '224', 'Espresso NEW', 9, 9, 'none', 0, null, false, null, null, null, null, 'exact', null, null, 117, 3, 4, 9, true, 'Import z realneho planogramu 58 / 2026-07-27.'),
    (v_machine_id, '10', 54, '225', 'Espresso Bile NEW', 9, 9, 'none', 0, null, false, null, null, null, null, 'exact', null, null, 230, 3, 3, 10, true, 'Import z realneho planogramu 58 / 2026-07-27.'),
    (v_machine_id, '11', 35, '221', 'CAPPUCCINO (E) 180 ml NEW', 9, 9, 'none', 0, null, false, null, null, null, null, 'exact', null, null, 1492, 3, 2, 11, true, 'Import z realneho planogramu 58 / 2026-07-27.'),
    (v_machine_id, '12', 88, '241', 'LATTE MACCHIATO (E) 180 ml NEW', 9, 9, 'none', 0, null, false, null, null, null, null, 'exact', null, null, 267, 3, 1, 12, true, 'Import z realneho planogramu 58 / 2026-07-27.'),
    (v_machine_id, '13', 55, '226', 'Espresso Lungo 180 ml NEW', 9, 9, 'none', 0, null, false, null, null, null, null, 'exact', null, null, 260, 4, 4, 13, true, 'Import z realneho planogramu 58 / 2026-07-27.'),
    (v_machine_id, '14', 56, '227', 'Espresso Lungo bile 180 ml NEW', 9, 9, 'none', 0, null, false, null, null, null, null, 'exact', null, null, 102, 4, 3, 14, true, 'Import z realneho planogramu 58 / 2026-07-27.'),
    (v_machine_id, '15', 95, '244', 'MOCCACCINO (E) 180 ml NEW', 9, 9, 'none', 0, null, false, null, null, null, null, 'exact', null, null, 252, 4, 2, 15, true, 'Import z realneho planogramu 58 / 2026-07-27.'),
    (v_machine_id, '16', 59, '228', 'ESPRESSO S KAKAOVYM NAPOJEM NEW', 9, 9, 'none', 0, null, false, null, null, null, null, 'exact', null, null, 59, 4, 1, 16, true, 'Import z realneho planogramu 58 / 2026-07-27.'),
    (v_machine_id, '17', 141, '240', 'Cerna kava 300 ml NEW', 13, 13, 'none', 0, null, false, null, null, null, null, 'exact', null, null, 516, 5, 4, 17, true, 'Import z realneho planogramu 58 / 2026-07-27.'),
    (v_machine_id, '18', 32, '216', 'Bila kava 300 ml NEW', 13, 13, 'none', 0, null, false, null, null, null, null, 'exact', null, null, 817, 5, 3, 18, true, 'Import z realneho planogramu 58 / 2026-07-27.'),
    (v_machine_id, '19', 37, '223', 'Cappuccino 300 ml NEW', 13, 13, 'none', 0, null, false, null, null, null, null, 'exact', null, null, 1009, 5, 2, 19, true, 'Import z realneho planogramu 58 / 2026-07-27.'),
    (v_machine_id, '20', 67, '229', 'Irish Cappuccino 300 ml NEW', 13, 13, 'none', 0, null, false, null, null, null, null, 'exact', null, null, 473, 5, 1, 20, true, 'Import z realneho planogramu 58 / 2026-07-27.'),
    (v_machine_id, '21', 72, '232', 'Kakaovy napoj 300 ml NEW', 13, 13, 'none', 0, null, false, null, null, null, null, 'exact', null, null, 303, 6, 4, 21, true, 'Import z realneho planogramu 58 / 2026-07-27.'),
    (v_machine_id, '22', 30, '218', 'Bila kremova 300 ml NEW', 13, 13, 'none', 0, null, false, null, null, null, null, 'exact', null, null, 267, 6, 3, 22, true, 'Import z realneho planogramu 58 / 2026-07-27.'),
    (v_machine_id, '23', 97, '246', 'MOCCACCINO 300 ml NEW', 13, 13, 'none', 0, null, false, null, null, null, null, 'exact', null, null, 503, 6, 2, 23, true, 'Import z realneho planogramu 58 / 2026-07-27.'),
    (v_machine_id, '24', 90, '243', 'LATTE MACCHIATO 300 ml NEW', 13, 13, 'none', 0, null, false, null, null, null, null, 'exact', null, null, 537, 6, 1, 24, true, 'Import z realneho planogramu 58 / 2026-07-27.')
  ...
  select v_machine_id, selection_code, product_name, product_sku, sale_price_czk, sale_price_czk, null, null, null, active, sort_order, selection_code, customer_price_czk, settlement_type, settlement_amount_czk, settlement_partner, settlement_billing_enabled, settlement_note, planned_product_name, planned_product_sku, planned_price_czk, substitution_policy, allowed_substitutes, operator_instruction, 'Zrcadlovy slot pro telemetrii kavy TID 596505 / automat 58 / Jihlava - Sonepar. Import z Excel planogramu 2026-07-27.'
